...
class setting_config:
    ...
    #Source_Dataset = 'REFUGE_Valid'
    Source_Dataset = 'ORIGA'
    #Target_Dataset = ['REFUGE_Valid']
    #Target_Dataset = ['RIM_ONE_r3']
    #Target_Dataset = ['REFUGE']
    #Target_Dataset = ['Drishti_GS']
    Target_Dataset = ['ORIGA']
    #Target_Dataset = ['RIM_ONE_r3', 'REFUGE', 'Drishti_GS', 'ORIGA']
    datasets = ('ODOC')
    if datasets == 'isic18':
